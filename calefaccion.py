...
# --- Configuracion --- python upload.py calefaccion.py as main.py --board calefaccion
MQTT_BROKER  = "192.168.1.135"
MQTT_PORT    = 1883
BOARD_NAME   = "calefaccion"
TOPIC_OTA    = f"boards/{BOARD_NAME}"
TOPIC_CMD    = "casa/calefaccion"
TOPIC_STATE  = "casa/calefaccion/state"
